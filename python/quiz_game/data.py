...
# ]
# Changed to get questions from Open Trivia DB API
import json
import urllib.request

question_data = []
with urllib.request.urlopen("https://opentdb.com/api.php?amount=10&category=9&difficulty=easy&type=boolean") as url:
